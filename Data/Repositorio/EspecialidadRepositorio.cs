...
namespace Data.Repositorio
{
    public class EspecialidadRepositorio : Repositorio<Especialidad>, IEspecialidadRepositorio
    {
        ...
        public void Actualizar(Especialidad especialidad)
        {
            ...
            {
                especialidadDb.NombreEspecialidad = especialidadDb.NombreEspecialidad;
                especialidadDb.Descripcion = especialidadDb.Descripcion;
                especialidadDb.Estado = especialidadDb.Estado;
